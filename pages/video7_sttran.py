...
st.subheader('분석 영상')
st.image('https://github.com/subninggg/streamlit/blob/main/sttran_gif/sb_out5_sttran.gif?raw=true')
st.link_button("뒤로 가기", "https://homepy-wgogeawchtyohpnvkzfyzx.streamlit.app/video7")
