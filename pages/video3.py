...
with col1:
    st.subheader('원본 영상')
    st.image('https://github.com/subninggg/streamlit/blob/main/video_gif/ge_safe24.gif?raw=true')
...
with col4:
    st.link_button("판정 분석 보러 가기", "https://homepy-wgogeawchtyohpnvkzfyzx.streamlit.app/video3_sttran")
