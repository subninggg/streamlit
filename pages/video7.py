...
with col1:
    st.subheader('원본 영상')
    st.image('https://github.com/subninggg/streamlit/blob/main/video_gif/sb_out5.gif?raw=true')

with col2:
    st.subheader('분석 영상')
    st.image('https://github.com/subninggg/streamlit/blob/main/hiera_gif/sb_out5_hiera.gif?raw=true')
...
st.subheader('')
st.subheader('분석 과정')
st.image('https://raw.githubusercontent.com/subninggg/streamlit/main/hiera_image/sb_out5_hiera.png')

col1, col2, col3, col4 = st.columns(4)
with col1:
    st.link_button("다른 영상 보러 가기", "https://homepy-wgogeawchtyohpnvkzfyzx.streamlit.app/")
with col4:
    st.link_button("판정 분석 보러 가기", "https://homepy-wgogeawchtyohpnvkzfyzx.streamlit.app/video7_sttran")
