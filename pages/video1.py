...
with col1:
    st.link_button("https://homepy-wgogeawchtyohpnvkzfyzx.streamlit.app/video1_sttran", label="\>\>판정 분석 보러가기")
with col6:
    st.link_button("https://homepy-wgogeawchtyohpnvkzfyzx.streamlit.app/", label="\>\>다른 영상 보러가기")
